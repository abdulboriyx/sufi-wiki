...
- **Supporters (later Sufis, e.g., Jami, Mulla Sadra):** *Wahdat al-wujud* is the highest metaphysical truth, not a denial of God's transcendence. The distinction between Creator and creation is preserved at the relational level even if not at the ontological level.
- **Orthodox critics (e.g., Ibn Taymiyya, d. 1328):** The doctrine collapses the distinction between God and creation (*hulul*, indwelling, or *ittihad*, union) — both of which are heretical in Sunni theology. Ibn Taymiyya mounted the most sustained medieval critique.
- **Rival doctrine — Wahdat al-Shuhud (Unity of Witness):** Sirhindi (d. 1624) proposed an alternative: the mystic's experience *seems* like unity, but this is a state of consciousness, not ontological fact. God and creation remain distinct. This became a major intra-Sufi debate.
